...
tinymce.PluginManager.add('media', function(editor, url) {
	var urlPatterns = [
        ...
        { regex: /v.youku\.com(.+)id_([^&]+).html/, type: 'iframe', w: 425, h: 350, url: 'http://player.youku.com/player.php/sid/$2/v.swf' },
        { regex: /www\.tudou\.com\/programs\/view\/([^&]+)/, type: 'iframe', w: 425, h: 350, url: 'http://www.tudou.com/v/$1/&bid=05&resourceId=0_05_05_99/v.swf' },
        { regex: /www\.tudou\.com\/listplay\/([^&]+)/, type: 'iframe', w: 425, h: 350, url: 'http://www.tudou.com/l/$1/&bid=05&resourceId=0_05_05_99/v.swf' },
