...
tinymce.PluginManager.add('imageupload', function (editor) {
    ...
    function showDialog(imageList, src) {
        ...
        var generalFormItems = [
                { name: 'file', type: 'textbox', subtype: 'file', label: 'Upload', onchange: function () { editBlogArticle.selectFileCallback(this) } },
                { name: 'src', type: 'filepicker', filetype: 'image', label: 'Source', autofocus: true, onchange: updateSize, value: src },
                imageListCtrl,
    ...
    editor.addCommand('mceImageWindow', function () {
        showDialog(true, editBlogArticle.ImageSrcToAdd);
    });
});