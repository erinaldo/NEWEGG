...
namespace TWNewEgg.API.View.Attributes
{
    ...
    public class FunctionNameAttributeValues
    {
        ...
        public const string ItemDetailEdit = "Item Detail Edit";
        ...
        public const string BatchCreateManufacturer = "Batch Manufaturer Creation";
        ...
        public const string BulletinsMessage = "Bulletins Message";
        public const string CategoryTreeView = "Category Tree VIew";
        public const string TwoDimensionProductCreation = "Two Dimension Item Create";
        public const string TwoDimensionItemList = "Two Dimension Item List";
        public const string Financial = "Financial";
        public const string RMAList = "RMA List";
    }
