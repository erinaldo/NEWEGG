...
{
    public class SalesOrder_View
    {
        public SalesOrder_View()
        {
            this.SalesOrderItem_ViewList = new List<SalesOrderItem_View>();
        }
        ...
        public List<SalesOrderItem_View> SalesOrderItem_ViewList { get; set; }
    }
}