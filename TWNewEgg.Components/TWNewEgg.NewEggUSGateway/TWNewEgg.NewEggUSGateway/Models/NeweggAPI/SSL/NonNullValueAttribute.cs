...
{
    /// <summary>
    /// Multi-field is null authentication.
    /// </summary>
    public class NonNullValueAttribute : ValidationAttribute, IClientValidatable
    {
        /// <summary>
        /// Properties string.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the NonNullValueAttribute class.
        /// </summary>
        /// <param name="properties">Properties string.</param>
        public NonNullValueAttribute(params string[] properties)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            var rule = new ModelClientValidationRule { ErrorMessage = errorMessage, ValidationType = "atleastonerequired", };
