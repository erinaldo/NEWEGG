...
namespace Newegg.Mobile.MvcApplication.Models
{
    ...
    public class PhoneFormatAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PhoneFormatAttribute class.
        /// </summary>
        /// <param name="properties">Properties string.</param>
        public PhoneFormatAttribute(params string[] properties)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            var rule = new ModelClientValidationRule { ErrorMessage = errorMessage, ValidationType = "phoneformat", };
            rule.ValidationParameters["properties"] = string.Join(",", this.propertiesmatter);
            yield return rule;
        }
