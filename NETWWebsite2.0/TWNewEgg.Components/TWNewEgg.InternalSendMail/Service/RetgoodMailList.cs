...
{
    public class RetgoodMailList
    {
        public void GetRetgoodMailList(TWNewEgg.DB.TWBACKENDDB.Models.Cart Cart)
        {
            ...
            //foreach(var typeNum in MailListMode.RetgoodList.ToList())
            //{
