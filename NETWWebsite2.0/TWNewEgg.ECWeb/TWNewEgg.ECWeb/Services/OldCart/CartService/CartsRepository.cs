...
namespace TWNewEgg.Website.ECWeb.Service
{
    public class CartsRepository : ICarts, IDisposable
    {
        ...
        private IItemPrice ItemPrice = new ItemPriceRepository();
        ...
        public string[] Decoder(string fromBody, bool uriDecode)
        {
            ...
            {
                splitEncode[i] = AesEnc.AESdecrypt(splitEncode[i]);
                if (i == 0)
                {
        ...
        public string[] DecoderIE(string fromBody, bool uriDecode)
        {
            ...
            string temp = AesEnc.AESdecrypt(fromBody);
        ...
        public IEnumerable<ShoppingCartItems> GetShoppingCart(int sortCode, string isOverSea)
        {
            ...
            using (var db = new TWSqlDBContext())
            {
                ...
                {
                    logger.Error("GetShoppingCart Track Error.");
                    logger.Error(string.Format("{0}_{1}", e.ToString(), ((e.InnerException == null) ? "" : e.InnerException.ToString())));
                    return null;
                }
        ...
        /// <returns></returns>
        public List<ShoppingCartItems> GetBuyingCart(int accountID, int sortCode, List<TWNewEgg.ItemService.Models.BuyingItems> BuyingCarts, string isOverSea)
        {
        ...
        public string AddTrack(List<int> itemIDs, List<int> itemlistIDs, int trackStatus)
        {
            ...
            {
                int sellingQty = GetSellingQty(itemID, "Item"); //check the item which had selling qty or not
                if (sellingQty <= 0)
                {
                    trackStatus = 1;
                    if (trackStatus == 0)
        ...
        /// <summary>
        /// Check the item can be buying or not, but this function is for set variable.
        /// </summary>
        ...
        public int GetSellingQty(int itemID, string tableName)
        {
            ...
            int itemQty = new int(); int itemQtyReg = new int(); int itemQtyLimit = new int(); int? itemStockQty = new int?(); int? itemStockQtyReg = new int?();
        ...
        public string UpdateTrack(List<int> itemIDs, int trackStatus, bool updateTime) //Done
        {
            ...
            try
            {
                foreach (var aUpdateTrack in updateTrack)
                {
                    ...
                    db.Track.Add(newtrack);
                    */
                    int sellingQty = GetSellingQty(aUpdateTrack.ItemID, "Item"); //check item left how many qty
                    if (sellingQty <= 0)
                    {
                        trackStatus = 1;
        ...
        public string AddTrackItem(int itemID, List<int> itemlistIDs, int trackStatus, int trackId)
        {
            ...
            if (itemlist.Count > 0)
            {
                ...
                {
                    int sellingQty = GetSellingQty(list, "ItemList"); //check there have qty
                    if (sellingQty > 0)
                    {
        ...
        public string AddTrackItem(int itemID, int itemlistID) //Done
        {
            ...
            try
            {
                int sellingQty = GetSellingQty(itemlistID, "ItemList");
                if (sellingQty > 0)
                {
        ...
        /// <returns></returns>
        public Dictionary<string, decimal> ShippingCosts(string buyingCartItems, string returnCategory, string shoptype = "index")
        {
            //var itemProducts;
            TWSqlDBContext db = new TWSqlDBContext();
            List<TWNewEgg.ItemService.Models.BuyingItems> PostData = GetBuyingCartItems(buyingCartItems);
        ...
        /// <returns></returns>
        public TWNewEgg.ItemService.Models.ShipTaxService ShippingCosts(List<TWNewEgg.ItemService.Models.BuyingItems> PostData, string shoptype = "index")
        {
            return ItemPrice.GetShippingCosts(PostData, shoptype);
        }
        /// <summary>
        /// Get shipping cost and taxdetail, first is count by program, last is call from stored procedure , this is for local items
        /// </summary>
        /// <param name="buyingItemslist"></param>
        /// <returns></returns>
        private TWNewEgg.ItemService.Models.ShipTaxService ShippingCosts20140402(List<TWNewEgg.ItemService.Models.BuyingItems> PostData, string shoptype = "index")
        {
            TWSqlDBContext db = new TWSqlDBContext();
            //var itemProducts;
            TWNewEgg.ItemService.Models.ShipTaxService shipTaxService = new TWNewEgg.ItemService.Models.ShipTaxService();
        ...
        /// <param name="isOverSea"></param>
        /// <returns></returns>
        public TWNewEgg.ItemService.Models.ShipTaxService ShippingCosts(List<TWNewEgg.ItemService.Models.BuyingItems> PostData, string isOverSea, string shoptype = "index")
        {
            TWSqlDBContext db = new TWSqlDBContext();
            //var itemProducts;
            TWNewEgg.ItemService.Models.ShipTaxService shipTaxService = new TWNewEgg.ItemService.Models.ShipTaxService();
        ...
        private void SetItemTaxDetailData(Dictionary<string, List<GetItemTaxDetail>> itemTaxDetail, string sellerID, List<string> itemforSP, decimal totalItemShipping, List<int> eachItemNumber, List<decimal> eachItemShippingFee, string shoptype = "index")
        {
            ItemPrice.SetItemTaxDetailData(itemTaxDetail, sellerID, itemforSP, totalItemShipping, eachItemNumber, eachItemShippingFee, shoptype);
        }
        /// <summary>
        /// acturally this function was changed all by Steven.S.Chen, so... XD  
        /// </summary>
        ...
        /// <param name="itemforSP"></param>
        /// <param name="totalItemShipping"></param>
        private void SetItemTaxDetailData20140402(Dictionary<string, List<GetItemTaxDetail>> itemTaxDetail, string sellerID, List<string> itemforSP, decimal totalItemShipping, string shoptype = "index")
        {
            TWSqlDBContext db = new TWSqlDBContext();
            int i = 0;
        ...
        {
            return ItemPrice.GetItemTaxDetails(itemid, itemlistid, shippingpricelist);
        }
        /// <summary>
        /// call stored procedure to get item tax detail
        /// </summary>
        ...
        /// <returns></returns>
        public List<TWNewEgg.ItemService.Models.BuyingItems> GetBuyingCartItems(string postData)
        {
            ...
            List<TWNewEgg.ItemService.Models.BuyingItems> PostData = new List<TWNewEgg.ItemService.Models.BuyingItems>();
            //string newPostData = postData.Replace("null", "");
            //newPostData = newPostData.Replace(",\"Coupons\":}", ",\"Coupons\":{}}");
            try
            {
                //PostData = serializer.Deserialize<List<TWNewEgg.ItemService.Models.BuyingItems>>(newPostData); //string to model object
                PostData = serializer.Deserialize<List<TWNewEgg.ItemService.Models.BuyingItems>>(postData); //string to model object
                return PostData;
            }
            catch (Exception e)
            {
                PostData.Add(new TWNewEgg.ItemService.Models.BuyingItems { buyItemID = 0, buyingNumber = 0 });
                return PostData;
            }
        ...
        {
            return ItemPrice.GetItemWeight(itemIDs, number, table);
        }
        ...
        /// <param name="sellerID"></param>
        /// <returns></returns>
        private decimal GetItemShipping(decimal weight, int sellerID, string shoptype = "index")
        {
            return ItemPrice.GetItemShipping(weight, sellerID, shoptype);
        }
        /// <summary>
        /// detemer weight and get shipping cost from db
        /// </summary>
        ...
        /// <param name="sellerID"></param>
        /// <returns></returns>
        private decimal GetItemShipping20140402(decimal weight, int sellerID, string shoptype = "index")
        {
            TWSqlDBContext db = new TWSqlDBContext();
        ...
        public decimal getTotalWeight(List<TWNewEgg.ItemService.Models.BuyingItems> PostData)
        {
            TWSqlDBContext db = new TWSqlDBContext();
            //var itemProducts;
            TWNewEgg.ItemService.Models.ShipTaxService shipTaxService = new TWNewEgg.ItemService.Models.ShipTaxService();
        ...
        public Dictionary<string, string> GetRootCategorybyItemIDs(List<int> itemIDs)
        {
            ...
            TWNewEgg.Website.ECWeb.Controllers.Api.CategoryController categoryController = new Controllers.Api.CategoryController();

            foreach (var aCategory in allCategory)
            {
                List<MapPath> allCategories;
                allCategories = categoryController.GetParents(aCategory.y.ID, aCategory.y.Layer, null, null, null).ToList();
