...
namespace TWNewEgg.ECWeb.Services.Account
{
    public class AccountService
    {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public AccountVM CheckGuestLogin(Login model)
        {
            if (!CorrectEmailFormat(model.user))
            {
                return null;
            }

            AccountVM result = _authService.CheckGuestAuth(model);
        ...
        //public RegistrationError CheckGuestRegister(RegisterVM RegisterVM)
        //{
        //    //錯誤訊息Model
        //    RegistrationError result = new RegistrationError();
